...
class SchemaBuilderTest extends TestCase
{
    ...
    public function testCreateWithCallback()
    {
        ...
        Schema::create('newtable', function ($collection) use ($instance) {
            $instance->assertInstanceOf('brunojk\LaravelRethinkdb\Schema\Blueprint', $collection);
        });
    ...
    public function testBluePrint()
    {
        ...
        Schema::table('newtable', function ($table) use ($instance) {
            $instance->assertInstanceOf('brunojk\LaravelRethinkdb\Schema\Blueprint', $table);
        });
    }
}
